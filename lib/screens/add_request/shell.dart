...
class _AddRequestScreenState extends State<AddRequestScreen> {
        ...
        content: Column(
          children: [
            ...
            FormBuilderTextField(
              ...
              decoration: const InputDecoration(
                labelText: 'Authoriser First Name',
                border: OutlineInputBorder(),
              ),
            ),
            const SizedBox(height: 16),
            FormBuilderTextField(
              ...
              decoration: const InputDecoration(
                labelText: 'Authoriser Last Name',
                border: OutlineInputBorder(),
              ),
            ),
            const SizedBox(height: 16),
        ...
        content: Column(
          children: [
            FormBuilderRadioGroup(
              name: 'has_consent',
              initialValue: request?.consentFormRef,
                            ...
                            onPressed: () async {
                              ...
                              try {
                                ...
                                await storage
                                    ...
                                    .putData(
                                        consentFormFile.files.single.bytes!,
                                        SettableMetadata(
                                ...
                                _requestFormKey
                                    .currentState!.fields['consent_form_ref']!
  ...
  Future<void> saveRequest({required bool submit}) async {
    BoomarangRequest newRequest = BoomarangRequest(
      ...
      consentStatus:
          hasConsent == true ? 'consent_received' : 'consent_pending',
